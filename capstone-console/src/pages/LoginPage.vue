<template>
  <q-page class="bg-primary text-white row items-center non-selectable">
    <div class="column justify-center q-pa-xl z-top">
      <div class="column content-start q-col-gutter-md">
        <div class="text-h4 text-bold">NO.1</div>
